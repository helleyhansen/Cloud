                ...
                <div class="container">
                    <div class="carousel-caption-inner">
                        ...
                        <p class="carousel-buttons">
                            ...
                            <?php if($sirius_banner_button_2_url != '') { ?><a href="<?php echo esc_url($sirius_banner_button_2_url); ?>" class="btn btn-blue"><?php echo esc_html($sirius_banner_button_2_label); ?></a><?php } ?>
                        </p>
                        <?php } ?>
                    </div>
                </div>
